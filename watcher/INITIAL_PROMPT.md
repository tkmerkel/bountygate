...
5. **Update the dashboard.** Read `C:\Users\tkmer\bountygate\dashboard\data.json`. Append one entry to `runs[]`:
   ```json
   {
     "run_id": "<basename of audit dir>",
     "timestamp": "<ISO 8601 from the audit dir prefix>",
     "player": "<from opportunity_info.json>",
     "market": "<from opportunity_info.json>",
     "outcome": "success" | "failure" | "skipped",
     "duration_s": <ffprobe duration of recording.mp4>,
     "estimated_wasted_wait_s": <number from the review, or null>,
     "issues": {
       "wasted_wait":   ["<concrete observation>", ...],
       "selector_miss": [...],
       "slip_state":    [...],
       "auth_geo":      [...],
       "stealth":       [...]
     },
     "top_finding": "<single sentence from the Top Finding section>",
     "recording": "file:///C:/Users/tkmer/bountygate/arbitrage_executor/audit_logs/<dir>/recording.mp4",
     "review":    "file:///C:/Users/tkmer/bountygate/arbitrage_executor/audit_logs/<dir>/review.md"
   }
   ```
   Trim `runs[]` to the most recent 500 entries (FIFO). Set `updated_at` to current ISO timestamp.
